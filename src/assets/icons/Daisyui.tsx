function Daisyui({ className }: { className?: string }) {
  return (
    <svg
    ...
    >
      ...
      <g opacity="0.7">
        <path
          fill="#ffd819"
          d="M84.315 22.535c-3.267 4.812-5.864 10.394-7.575 16.748A53.08 53.08 0 0 1 39.283 76.74c-6.353 1.71-11.936 4.307-16.748 7.575c-6.82-35.674 26.106-68.6 61.78-61.78"
        />
        <path
          fill="#ffe029"
          d="M22.536 84.314c1.092 5.713 3.204 11.497 6.486 17.199a53.08 53.08 0 0 1 0 52.973c-3.283 5.702-5.394 11.485-6.486 17.198c-30.048-20.402-30.048-66.967 0-87.37"
        />
        <path
          fill="#ffc141"
          d="M84.315 233.463c-3.267-4.811-5.864-10.394-7.575-16.747a53.08 53.08 0 0 0-37.457-37.458c-6.353-1.71-11.936-4.307-16.748-7.575c-6.82 35.674 26.106 68.6 61.78 61.78"
        />
        <path
          fill="#ffb655"
          d="M171.685 233.463c-5.713-1.092-11.496-3.204-17.198-6.486a53.08 53.08 0 0 0-52.973 0c-5.702 3.282-11.486 5.394-17.199 6.486c20.403 30.048 66.968 30.048 87.37 0"
        />
        <path
          fill="#ffb35b"
          d="M233.465 171.684c-4.812 3.268-10.394 5.863-16.748 7.574a53.08 53.08 0 0 0-37.457 37.458c-1.71 6.353-4.307 11.936-7.575 16.747c35.673 6.82 68.6-26.106 61.78-61.78"
        />
        <path
          fill="#ffb656"
          d="M233.465 84.315c-1.093 5.713-3.204 11.496-6.487 17.198a53.09 53.09 0 0 0 0 52.973c3.283 5.702 5.394 11.485 6.487 17.198c30.047-20.402 30.047-66.966 0-87.37"
        />
        <path
          fill="#ffc042"
          d="M171.685 22.535c3.268 4.812 5.864 10.394 7.575 16.748a53.09 53.09 0 0 0 37.457 37.457c6.354 1.71 11.936 4.307 16.748 7.574c6.82-35.673-26.107-68.599-61.78-61.78"
        />
        <path
          fill="#ffce2a"
          d="M84.315 22.535c5.713 1.093 11.496 3.204 17.199 6.487a53.08 53.08 0 0 0 52.972 0c5.703-3.283 11.486-5.394 17.199-6.487c-20.403-30.047-66.967-30.047-87.37 0"
        />
      </g>
      <path
        fill="url(#SVGo2fMIbbC)"
      ...
      <path
        fill="#ffa17a"
        d="m180.675 147.783l4.465 7.734a4.466 4.466 0 0 1-7.734 4.466l-4.466-7.735a4.466 4.466 0 0 1 7.735-4.465m-11.163-.001l4.466 7.734a4.466 4.466 0 0 1-7.735 4.466l-4.465-7.735a4.466 4.466 0 0 1 7.734-4.465"
      />
      <path
        fill="#ffab89"
        d="m90.249 147.782l4.465 7.735a4.466 4.466 0 0 1-7.734 4.465l-4.466-7.734a4.466 4.466 0 0 1 7.735-4.466m-11.164.001l4.465 7.734a4.466 4.466 0 0 1-7.734 4.466l-4.466-7.735a4.466 4.466 0 0 1 7.735-4.465"
      />
      <path
        fill="#ffa17a"
        d="m172.87 94.833l8.626 2.312a4.466 4.466 0 0 1-2.312 8.627l-8.626-2.312a4.466 4.466 0 0 1 2.311-8.627"
      />
      <path
        fill="#ffab89"
      ...
      <g stroke-linecap="round" stroke-width="12">
        ...
        <path
          stroke="#d05b34"
          d="M118.24 142.799c2.355 2.61 6.532 4.465 10.048 4.465c3.514 0 7.692-1.856 10.047-4.465"
        />
      </g>
